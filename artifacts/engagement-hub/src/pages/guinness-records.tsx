...
import { useHofCategories, useCurrentHofRecords, useCreateHofCategory } from "@/hooks/use-guinness-records";
import { HOF_ICON_OPTIONS, getHofIcon } from "@/lib/icon-map";

export default function GuinnessRecords() {
  ...
  return (
    <PageTransition className="p-4 md:p-8 max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <Badge variant="accent" className="mb-2">🏆 All-Time Company Records</Badge>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Guinness Records</h1>
